...
function Council() {
	return (
		<section className="py-12 lg:py-16 bg-[#F7F6F6]">
			<div className="max-w-7xl px-4 mx-auto">
				...
				<p className="text-center text-gray-700 ">
					Aktualny skład Rady Sołeckiej Sołectwa Czepino (kadencja 2019-2024)
				</p>
				<div className="flex gap-7 justify-evenly flex-wrap pt-12 gap-y-12">
