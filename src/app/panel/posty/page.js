		...
		<section className="w-full px-4 lg:px-6 pb-8">
			...
			">
				<SettingsBox title="Moje posty" long>
					{posts.length > 0 && (
						<div className="w-full flex overflow-x-auto items-center justify-start border border-slate-200 py-3 text-center font-extrabold text-gray-800 lg:text-lg xl:text-xl lg:py-5 bg-slate-50">
							<div className="w-14">
								<p>ID</p>
							</div>
					...
					<div className="w-full flex flex-col overflow-x-auto">
						{posts.length > 0 ? (
							posts.map(post => {
								...
								return (
									<div
										className="w-full flex  items-center justify-start border-b  border-slate-200 py-5 text-center font-semibold text-gray-700 lg:text-lg bg-white md:hover:bg-slate-100 transition-colors duration-300"
										key={post.id}>
